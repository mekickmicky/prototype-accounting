...
1. Extract this folder into the root of a fresh repo
2. Open Claude Code in that repo
3. Start your first session with:

   > "Read `CLAUDE.md`, then read all specs in order 01–11. Then begin Phase 1 from `specs/11-build-phases.md`. Maintain a `TASKS.md` at the repo root tracking progress. Do not advance phases until all acceptance criteria are met."

4. Open `wireframes/*.html` in a browser to see the actual visual target
5. Review at end of each phase using the acceptance criteria checklists
